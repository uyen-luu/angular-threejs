...
import { ThCanvas, ThPointLight, ThInstancedMesh } from 'ngx-three';
import { Object3D } from 'three';
import SimplexNoise from 'simplex-noise';

@Component({
  selector: 'app-instanced-mesh',
  templateUrl: './instanced-mesh.component.html',
  styleUrls: ['./instanced-mesh.component.scss']
})
export class InstancedMeshComponent implements OnInit {
  readonly SIZE = 1.5;
  readonly NX = 20;
  readonly NY = 20;
  readonly PADDING = 1;
